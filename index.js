...
const last_entryRouter = require("./routers/last_entry.router.js");
...
app.use("/last_entries", auntheticateUser, logActivity, last_entryRouter);
app.use("/milkrates", auntheticateUser, logActivity, milkrateRouter);
